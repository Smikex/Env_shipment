...
(function(root, factory) {
            ...
            setup: function() {
                if (this.opts.offCanvas) {
                    ...
                    if (y = n[t].glbl, "boolean" == typeof x && x && (x = {
                        drop: x
                    }), "object" != typeof x && (x = {}), "string" == typeof x.position && (x.position = { of: x.position
        ...
        c[n].addons[t] = {
            setup: function() {
                var e = this,
                    s = this.opts[t];
                this.conf[t];
                if (c[n].glbl, s instanceof Array && (s = {
                    add: !0,
                    top: s
                }), s.add) {
                    var r = null;
                    if (c.each(["top", "bottom"], function(a, n) {
                        ...
                        for (var e = c('<div class="' + d.iconbar + "__" + n + '" />'), i = 0, o = t.length; i < o; i++) e.append(t[i]);
                        e.children().length && (r || (r = c('<div class="' + d.iconbar + '" />')), r.append(e))
                    }), r && (this.bind("initMenu:after", function() {
                        var a = d.menu + "_iconbar";
                        s.size && (a += " " + d.menu + "_iconbar-" + s.size), this.$menu.addClass(a).prepend(r)
                    }), "tabs" == s.type)) {
                        ...
                        i.on(a.click + "-" + t, function(a) {
                            ...
                            if (n.hasClass(d.iconbar + "__tab_selected")) a.stopImmediatePropagation();
                                ...
                                var t = c(n.attr("href"));
                                t.hasClass(d.panel) && (a.preventDefault(), a.stopImmediatePropagation(), e.__openPanelWoAnimation(t))
                            } catch (a) {}
            ...
            add: function() {
                d = c[n]._c, o = c[n]._d, a = c[n]._e, d.add(t)
            },
    ...
    ! function(o) {
        ...
        o[n].addons[_] = {
            ...
            if (e.find("." + f.searchfield).length) return o();
    ...
    ! function(i) {
        var t = "mmenu";
        i[t].addons.navbars.searchfield = function(s, e) {
            var a = i[t]._c,
                d = i('<div class="' + a.searchfield + '" />').appendTo(s);
            "object" != typeof this.opts.searchfield && (this.opts.searchfield = {}), this.opts.searchfield.add = !0, this.opts.searchfield.addTo = d
        }
    }(jQuery);
    ! function(d) {
        var o = "mmenu",
            _ = "navbars";
        d[o].addons[_].tabs = function(a, t, e) {
            var s = d[o]._c,
                r = d[o]._d,
                n = d[o]._e,
                i = this,
                l = a.children("a");
            a.addClass(s.navbar + "_tabs").parent().addClass(s.navbars + "_has-tabs"), l.on(n.click + "-" + _, function(a) {
                a.preventDefault();
                var t = d(this);
                if (t.hasClass(s.navbar + "__tab_selected")) a.stopImmediatePropagation();
                else try {
                    i.__openPanelWoAnimation(d(t.attr("href"))), a.stopImmediatePropagation()
                } catch (a) {}
            }), this.bind("openPanel:start", function a(t) {
                l.removeClass(s.navbar + "__tab_selected");
                var e = l.filter('[href="#' + t.attr("id") + '"]');
                if (e.length) e.addClass(s.navbar + "__tab_selected");
                else {
    ...
    jQuery.mmenu.i18n({
        ...
        "Search results": "Ð ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚Ñ‹ Ð¿Ð¾Ð¸ÑÐºÐ°"
    }, "ru");
    return true;
}));